          ...
          <div className="text-center mb-6">
            ...
            {member.guardianData && (
              <div className="flex items-center justify-center gap-2">
                ...
                >
                  {member.guardianData.name}
                </p>
                <span
                  className="text-xs px-2 py-0.5 rounded font-bold"
                  style={{
                    backgroundColor: `${member.guardianData.color}30`,
                    color: member.guardianData.color
                  }}
                >
                  S{member.guardianData.stage ?? 0}
                </span>
                <span className="text-slate-400 text-sm">
                  {member.guardianData.stageName || '卵'}
                </span>
              </div>
            )}
          </div>
...
function StatRow({
  ...
  return (
    <div
      className={`flex items-center justify-between p-3 rounded-xl transition-colors ${highlight ? 'glass-bg border' : 'bg-white/5'
        }`}
