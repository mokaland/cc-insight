...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 p-4 pt-24 pb-8 overflow-y-auto relative">
      {/* 守護神テーマ背景エフェクト */}
